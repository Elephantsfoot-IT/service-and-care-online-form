...
function ServiceAgreement() {
  ...
  return (
    <div className="w-full flex flex-col items-center font-sans pt-10 pb-20 bg-white flex-grow gap-8 max-w-screen-lg mx-auto">
      ...
      {state.page === 5 && (
        <div
          className={`${
            fadeInStates.fadeIn5 ? "fade-up" : "opacity-0"
          } w-full flex flex-col`}
        >
      ...
      {state.page === 6 && (
        <div
          className={`${
            fadeInStates.fadeIn6 ? "fade-up" : "opacity-0"
          } w-full flex flex-col`}
        >
