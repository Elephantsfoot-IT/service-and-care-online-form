...
const SERVICES: ServiceDef[] = [
  ...
  },
  {
    ...
    levelLabel: "Area (m²)",
    rows: [
      { site: "Darlinghurst",  level: "0 m² – 20 m²", price: 425.00 },
      { site: "Wahroonga",  level: "21 m² – 40 m²", price: 490.00 },
      { site: "Miranda ACH",  level: "41 m² – 60 m²", price: 550.00 },
      { site: "Miranda Mason",  level: "61 m² – 80 m²", price: 600.00 },
    ],
  },
  {
    key: "odour-control",
    title: "Odour Control",
    description: "Neutralises smells at source, maintains fresher environments.",
    unitLabel: "(per system, excl. GST)",
    rows: [
...
function SeriveAgreement() {
  ...
  const [chuteCleaningFrequency, setChuteCleaningFrequency] = useState<MaybeOption>();
  const [equipmentMaintenanceFrequency, setEquipmentMaintenanceFrequency] = useState<MaybeOption>();
  const [wasteRoomCleaningFrequency, setWasteRoomCleaningFrequency] = useState<MaybeOption>();
  const [odourControlFrequency, setOdourControlFrequency] = useState<MaybeOption>();
  const [selfClosingHopperDoorInspectionFrequency, setSelfClosingHopperDoorInspectionFrequency] = useState<MaybeOption>();
  const [binCleaningFrequency, setBinCleaningFrequency] = useState<MaybeOption>();
  ...
  const getFrequency = (key: ServiceKey): MaybeOption|undefined => {
    switch (key) {
      case "chute-cleaning": return chuteCleaningFrequency;
      case "equipment-maintenance": return equipmentMaintenanceFrequency;
      case "waste-room-cleaning": return wasteRoomCleaningFrequency;
      case "odour-control": return odourControlFrequency;
      case "self-closing-hopper-door-inspection": return selfClosingHopperDoorInspectionFrequency;
      case "bin-cleaning": return binCleaningFrequency;
    }
  };
  const setFrequency = (key: ServiceKey, v: MaybeOption) => {
    switch (key) {
      case "chute-cleaning": return setChuteCleaningFrequency(v);
      case "equipment-maintenance": return setEquipmentMaintenanceFrequency(v);
      case "waste-room-cleaning": return setWasteRoomCleaningFrequency(v);
      case "odour-control": return setOdourControlFrequency(v);
      case "self-closing-hopper-door-inspection": return setSelfClosingHopperDoorInspectionFrequency(v);
      case "bin-cleaning": return setBinCleaningFrequency(v);
    }
  };
  ...
  }, [chuteCleaningFrequency, equipmentMaintenanceFrequency, wasteRoomCleaningFrequency, odourControlFrequency, selfClosingHopperDoorInspectionFrequency, binCleaningFrequency]);
        ...
        <div className="my-20 max-w-screen-xl w-full mx-auto">
          <div className="min-h-[200px] flex flex-col gap-10 my-20">
            ...
            {SERVICES.map((svc) => {
              ...
              return (
                <div key={svc.key} className="border border-neutral-200 shadow overflow-hidden ">
                  <div className="flex flex-row items-end justify-between gap-4 border-b border-neutral-200 px-6 py-4 bg-neutral-50">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-3xl font-medium">{formatMoney(total)}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col divide-y divide-neutral-200 text-sm px-6 py-4">
                    <div className="grid grid-cols-6 gap-2">
                      ...
                      <div className="col-span-1 px-4 py-2 font-medium">{svc.rows[0].qty ? "Qty" : ""}</div>
                      <div className="col-span-1 px-4 py-2 font-medium">{svc.rows[0].level ? svc.levelLabel : ""}</div>
                      <div className="col-span-1 text-right px-4 py-2 font-medium">
                        Price <span className="font-normal text-neutral-600">{svc.unitLabel}</span>
                      </div>
                    </div>
          ...
          <div className="flex flex-col gap-2 items-center">
            <div className="text-4xl font-medium text-[#1e60ad]">Exclusive Benefits</div>
