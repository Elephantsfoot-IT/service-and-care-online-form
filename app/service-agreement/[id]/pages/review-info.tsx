...
export default function ReviewInfo() {
  ...
  return (
    <div className="w-full mx-auto">
      ...
      {/* Company Details */}
      <div className="p-6 flex flex-col gap-2 mt-4 mb-6 border border-neutral-200 rounded-md shadow-xs">
      ...
      <>
        {state.additionalContacts.map((contact, index) => (
          <div
            key={contact.id}
            className="p-6 flex flex-col gap-2 mt-4 mb-6 border border-neutral-200 rounded-md shadow-xs"
          >
            <div className="flex flex-row space-x-4 items-center">
