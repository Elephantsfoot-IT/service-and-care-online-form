    ...
    <SectionShell id="chute_cleaning">
      ...
      <SectionDetails>
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            ...
            <a href="https://www.elephantsfoot.com.au/chute-cleaning/" className="underline text-efg-yellow" target="_blank">
              our website
            </a>
          </li>
        </ul>
      ...
      <SectionContent>
        ...
        <div className="sm:hidden w-full flex flex-col rounded-xl bg-neutral-75 p-4">
          ...
          {details.items.map((r, i) => (
            <div key={i} className="flex flex-row gap-2 border-b border-input last:border-b-0 text-sm xl:text-base">
