    ...
    <div className="flex flex-row gap-6 w-full py-10 items-center">
      <div
        className={cn(
          ...
          currentTier === "basic"
            ? "shadow-xl bg-gradient-to-br from-neutral-200  to-neutral-300 "
      ...
      <div
        className={cn(
          ...
          currentTier === "essential"
            ? "shadow-xl bg-gradient-to-tl from-[#ffdb01]  to-yellow-300 border border-transparent text-black"
            : "border border-neutral-100"
        )}
      >
        {currentTier === "pro" && (
      ...
      >
        ...
        {currentTier === "pro" ? (
          <>
            <div className="text-3xl font-bold  mt-2">Eligible</div>
            <div className="mb-6 text-sm invisible">dummy</div>
          </>
        ) : (
          <>
